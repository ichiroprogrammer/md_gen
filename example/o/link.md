...
と書けば、「[外部ファイルの一部抜粋(インデントの変更なし)](ref.md#SS_2_1)」へジャンプできるようになる。
...
見出し「"[code/example_code.cpp](sample_code.md#SS_4_1_1)"」が作ら、上記にそこへのリンクが張られる。
...
[外部ファイルの参照](link.md#SS_3_2)で述べたsample_code.mdは、
